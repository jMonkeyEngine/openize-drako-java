...
import dev.openize.drako.AsposeUtils;
import dev.openize.drako.BitUtils;
import dev.openize.drako.ByteSpan;
import dev.openize.drako.FloatSpan;
import dev.openize.drako.Struct;
...
{    
    static final class ValueKey implements Comparable<ValueKey>, Struct<ValueKey>, Serializable
    {
        ...
        static final long serialVersionUID = 68930950L;
        @Override
        public int hashCode()
        {
            return (int)hashCode;
     ...
     * @return Instance of {@link dev.openize.drako.PointAttribute} wrapped from the vectors.
     */
     ...
     *
     * @param attIndex Index to the attribute entry
     * @param outData Byte array to receive the attribute entry value
     */
     ...
     *
     * @param newNumUniqueEntries Number of unique entries
     */
     ...
     *
     * @return  Functions for setting the type of mapping between point indices and
 attribute entry ids.
 This function sets the mapping to implicit, where point indices are equal
 to attribute entry indices.
     */
     ...
     *
     * @param numPoints Number of actual points
     */
     ...
     *
     * @param pointIndex Index to the point
     * @param entryIndex Index to the attribute entry
     */
     ...
     *
     * @param index Index of the attribute entry
     * @param buffer Source raw bytes to copy from
