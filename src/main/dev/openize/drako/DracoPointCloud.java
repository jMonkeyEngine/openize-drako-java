...
{    
    static final class VertexIndex implements Comparable<VertexIndex>, Struct<VertexIndex>, Serializable
    {
        ...
        static final long serialVersionUID = -1263541792L;
        @Override
        public int hashCode()
        {
            int hash = 0;
     ...
     *
     * @param type What type of attribute to count, defined by {@link dev.openize.drako.AttributeType}
     ...
     *
     * @param type What type of attribute to find, defined by {@link dev.openize.drako.AttributeType}
